...
{	  
	[Binding, Scope(Feature = "Gherkin and SpecFlow demonstration")]
	...
	{	   
		...
		[Given(@"I have entered some numbers ""(.*)""")]
		public void GivenIHaveEnteredSomeNumbers(int p0)
		{
			_driver.FindElement(By.TagName("input")).SendKeys(p0.ToString());
		}
